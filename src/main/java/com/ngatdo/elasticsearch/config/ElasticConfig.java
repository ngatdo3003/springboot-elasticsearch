package com.ngatdo.elasticsearch.config;
...
/**
 * Hàm tạo Bean Elasticsearch Client cho java spring app
 */
@Configuration
public class ElasticConfig {
    ...
    public RestHighLevelClient client(){
        ...
        // Nếu server elasticsearch cần authenticate, ta set username và mật khẩu cho nó
        final CredentialsProvider credentialsProvider =new BasicCredentialsProvider();
        credentialsProvider.setCredentials(AuthScope.ANY,new UsernamePasswordCredentials("username", "password"));

        // Tạo connection đến server với timeout
